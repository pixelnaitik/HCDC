...
// Detect base path for assets (works on file://, localhost, and GitHub Pages)
function getAssetPath(relativePath) {
    // Remove /HCDC/ prefix if present
    const cleanPath = relativePath.replace(/^\/?HCDC\//, '');

    // If we're using file:// protocol or localhost, check if we're in a subdirectory
